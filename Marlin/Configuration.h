...
#define STRING_CONFIG_H_AUTHOR "(Steve Whitcher - SKR Mini E3 DIP)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Whitcher-3"
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -47, -4, 0 }
